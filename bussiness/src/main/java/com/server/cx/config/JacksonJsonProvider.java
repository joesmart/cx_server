...
public class JacksonJsonProvider
        ...
        Versioned
{
    private static Logger logger = LoggerFactory.getLogger(JacksonJsonProvider.class);
    /**
            ...
            throws IOException
    {
        ...
        stopwatch.stop();
        logger.info("JacksonJson serialize time:"+stopwatch.elapsedTime(TimeUnit.MICROSECONDS));
