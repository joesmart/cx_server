...
public class AuditInterceptor extends EmptyInterceptor {
    ...
    private boolean checkCreatedBy(Object[] currentState, Auditable auditable, String username, int idx,
                                   String propertyName) {
    ...
    private boolean checkUpdatedBy(Object[] currentState, Auditable auditable, String username, int idx,
                                   String propertyName) {
