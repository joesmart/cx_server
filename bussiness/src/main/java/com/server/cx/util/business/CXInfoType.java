...
public enum CXInfoType {
  ...
  PICTURE("picture", "1"), VIDEO("video", "2"), AMINATION("Animation", "3"), UNKNOW("unknow", "4");
  ...
  public CXInfoType getType(String fileExtentionType) {
    ...
    if ("jpg".equalsIgnoreCase(fileExtentionType) || "jpeg".equalsIgnoreCase(fileExtentionType)
        || "png".equalsIgnoreCase(fileExtentionType) || "bmp".equalsIgnoreCase(fileExtentionType)) {
