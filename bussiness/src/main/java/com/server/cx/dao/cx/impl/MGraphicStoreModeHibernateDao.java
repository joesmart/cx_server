...
@Transactional
public class MGraphicStoreModeHibernateDao extends GenericDaoHibernate<MGraphicStoreMode, String>
    implements MGraphicStoreModeDao {
  public MGraphicStoreModeHibernateDao() {
    super(MGraphicStoreMode.class);
  }
  ...
  public MGraphicStoreMode getDefaulModeUserCXInfo() throws SystemException {
    ...
    try {
      ...
      List<MGraphicStoreMode> list = super.getHibernateTemplate().findByCriteria(criteria);
  ...
  public List<MGraphicStoreMode> getAllMGraphicStoreModeByUserId(Long userId) {
    ...
    List<MGraphicStoreMode> result = getHibernateTemplate().findByCriteria(detachedCriteria);
    return result;
  }
  ...
  public MGraphicStoreMode getCurrentValidStatusMGraphicStoreMode(Long userId, Integer currentHour) {
    ...
    List<MGraphicStoreMode> list = getHibernateTemplate().findByCriteria(detachedCriteria);
    if (list != null && list.size() > 0) {
      return list.get(0);
    } else {
      return null;
